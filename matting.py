...
class SkyDetector:
    def __init__(self, args, dataloaders):
        ...
        self.net_G = define_G(input_nc=3, output_nc=1, ngf=64, netG=args.net_G).to(
            device
        )
        self.lr = args.lr
    ...
    def _collect_epoch_states(self):
        ...
        print(
            "is training: %s epoch %d / %d, epoch_acc= %.5f"
    ...
    def _update_checkpoints(self):
        ...
        print(
            "lastlest model updated. Epoch_acc=%.4f, Historical_best_acc=%.4f (at epoch %d)"
    ...
    def train_models(self):
        ...
        for self.epoch_id in range(self.epoch_to_start, self.max_num_epochs):
            ...
            self.net_G.train()
            # iterate over data
            for self.batch_id, batch in enumerate(self.dataloader["train"], 0):
